...
namespace ConstructionLine.CodingChallenge.Tests
{
    public class SearchEngineTestsBase
    {
            ...
            foreach (var size in Size.All)
            {
                ...
                var expectedSizeCount = shirts
                    .Count(s => s.Size.Id == size.Id
                                && (
                                (
                                !searchOptions.Colors.Any() && sizeCounts.Any(x => x.Count > 0 && x.Size == s.Size)) ||
        ...
        protected static void AssertSizeCounts(List<Shirt> shirts, List<SizeCount> sizeCounts)
        {
            Assert.That(sizeCounts, Is.Not.Null);
            ...
            foreach (var color in Color.All)
            {
                ...
                var expectedColorCount = shirts
                    .Count(c => c.Color.Id == color.Id
                                && (
                                (
                                !searchOptions.Sizes.Any() && colorCounts.Any(x => x.Count > 0 && x.Color == c.Color)) ||
        ...
        protected static void AssertColorCounts(List<Shirt> shirts, List<ColorCount> colorCounts)
        {
            Assert.That(colorCounts, Is.Not.Null);
